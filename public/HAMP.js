...
setInterval(function () {
  ...
  xhr.onload = function () {
    ...
    adbpA1 = ((parseFloat(adbc1) * parseFloat(adbv)) / 1000).toFixed(2);
    adbpA2 = ((parseFloat(adbc2) * parseFloat(adbv)) / 1000).toFixed(2);
  ...
  cVal.innerText = (parseFloat(adbc1) + parseFloat(adbc2)).toFixed(2) + " mA";
